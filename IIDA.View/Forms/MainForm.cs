    ...
    public partial class MainForm : Form, IMainForm
    {
        ...
        private void GetData()
        {
            ...
            else
            {
                ...
                //string query = "SELECT top 1000 ID_Key, Feature_Index, Type_Index, Latitude, Longitude, Altitude FROM Tablitca_osobennostei";
                string query = "SELECT Top 10000 * FROM Tablitca_osobennostei";
                //string query = "SELECT * FROM Tablitca_osobennostei";
